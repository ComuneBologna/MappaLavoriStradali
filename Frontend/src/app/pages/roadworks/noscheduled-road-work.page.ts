...
export class NoScheduledRoadWorksPage extends RoadWorksPage {
    constructor(_roadWorkService: RoadWorkService, _dialog: MatDialog, _activatedRoute: ActivatedRoute, _eventBusService: EventBusService) {
        super(_roadWorkService, _dialog, RoadWorkCategories.NotScheduled, _activatedRoute, _eventBusService)
    }
}
