...
namespace Asf.RoadWorks.BusinessLogic.Models
{
	...
	/// 
	/// </summary>
	/// <seealso cref="SmartTech.Infrastructure.Search.SearchCriteria" />
	public class RoadWorksSearchCriteria : FilterCriteria
	{
		/// <summary>
		...
		/// The publish status.
		/// </value>
		public PublishStatusForSearch? PublishStatus { get; set; }
	...
	[Flags]
	public enum PublishStatusForSearch
	{
		None = 0,
		Draft = 1,
		WaitingToApprove = 2,
